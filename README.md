...
By: Saketh Marrapu, Ryan Anderson and Shruthi Venkataraman
...
**EnzymeClassificationUsingGraphs.pdf** - This is the final report of our findings and interpration of results

**eda.R** - This file contains the code for the exploratory data analysis of the graph properties based on EC class

**ClassicalMachineLearningModels.ipynb** - This file contains the code for the machine learning methods: Random Forest, XGBoost, Logistic Regression, and SVM.
